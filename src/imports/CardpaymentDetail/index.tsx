import svgPaths from "./svg-waowxgxsxd";
import imgMapa from "./e5ee152311448b40a9a634159a7a41b21914258e.png";
...
import { imgAvatar } from "./svg-sfx0v";
...
function Content2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Content">
      ...
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#006dff] text-[16px] text-center whitespace-nowrap">Madrid</p>
    </div>
  );
}
...
function MetodoDePago() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center relative shrink-0" data-name="Método de pago">
...
function Body1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center justify-center relative shrink-0 w-full" data-name="Body">
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] max-h-[48px] min-w-full overflow-hidden relative shrink-0 text-[#646464] text-[16px] text-center text-ellipsis w-[min-content]">Compra - Zara Mad-Serrano</p>
      <div className="content-stretch flex items-baseline relative shrink-0" data-name="Amount">
        <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[24px] text-black whitespace-nowrap">-120</p>
      ...
      <p className="[word-break:break-word] font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] overflow-hidden relative shrink-0 text-[16px] text-black text-center text-ellipsis whitespace-nowrap">Compra en comercio</p>
...
function Header() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center min-w-[360px] pb-[24px] relative shrink-0 w-full" data-name="Header">
      <div className="h-[156px] mb-[-32px] relative shrink-0 w-full" data-name="Mapa">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMapa} />
      </div>
      <div className="absolute bg-white min-w-[96px] right-[16px] rounded-[50px] top-[16px]" data-name="Button">
...
export default function CardpaymentDetail() {
  return (
    <div className="relative size-full" data-name="cardpayment detail">
