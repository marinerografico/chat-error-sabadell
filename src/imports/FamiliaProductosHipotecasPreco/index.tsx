import svgPaths from "./svg-lhy58zssmt";
...
function RightSide() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(83.33%-0.3px)] top-[19px]" data-name="Right Side">
      <div className="-translate-x-1/2 absolute h-[13px] left-[calc(83.33%+24.7px)] top-[19px] w-[27.401px]" data-name="_StatusBar-battery">
      ...
      <div className="-translate-x-1/2 absolute h-[11.834px] left-[calc(83.33%-4.5px)] top-[20px] w-[17px]" data-name="Wifi">
      ...
      <div className="-translate-x-1/2 absolute h-[12px] left-[calc(83.33%-30px)] top-[20px] w-[18px]" data-name="Icon / Mobile Signal">
  ...
  return (
    <div className="content-stretch flex flex-col h-[44px] items-start justify-center relative shrink-0 w-full" data-name="Text">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Libre_Franklin:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px overflow-hidden relative text-[16px] text-black text-center text-ellipsis w-full whitespace-nowrap">
        <p className="leading-[24px] overflow-hidden text-ellipsis">Contratar hipoteca</p>
      </div>
    </div>
  );
}
...
function Actions() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-end relative shrink-0 w-[80px]" data-name="Actions">
          ...
          <div className="h-[19.155px] relative shrink-0 w-[20px]" data-name="vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 19.1552">
              <g id="vector">
                ...
                <path d={svgPaths.p3c5b5a00} fill="var(--fill-0, white)" />
                <path d={svgPaths.p37ef3600} fill="var(--fill-0, white)" />
              </g>
            </svg>
          </div>
        </div>
...
function Top() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Top">
      <div className="bg-white h-[47px] overflow-clip relative shrink-0 w-full" data-name="System_StatusBar">
        <Notch />
        <LeftSide />
        <RightSide />
      </div>
...
function Tag() {
  return (
    <div className="bg-[#ccecda] content-stretch flex gap-[8px] items-center justify-center pl-[12px] pr-[16px] py-[4px] relative rounded-[20px] shrink-0" data-name="Tag">
      <div className="content-stretch flex flex-col items-start px-[2px] py-[3px] relative shrink-0" data-name="Star">
        <div className="h-[18px] relative shrink-0 w-[20px]" data-name="vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 18">
            <path clipRule="evenodd" d={svgPaths.p6104280} fill="var(--fill-0, black)" fillRule="evenodd" id="vector" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] max-h-[20px] overflow-hidden relative shrink-0 text-[14px] text-black text-ellipsis whitespace-nowrap">Promoción</p>
    </div>
  );
}
...
function Content2() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Content">
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#006dff] text-[16px] text-center whitespace-nowrap">Me interesa</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-black w-full" data-name="Title Text">
        <p className="font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">[Antonio], tienes una hipoteca preaprobada a tu disposición</p>
        <p className="font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] w-full">Estás a un paso de acceder a tu nuevo hogar</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-start max-w-[736px] relative shrink-0 w-full" data-name="Button Set">
        <div className="bg-white min-w-[96px] relative rounded-[100px] shrink-0" data-name="Button">
...
function Icon() {
  return (
    <div className="bg-[#ccecda] content-stretch flex items-center justify-center px-[16px] py-[6px] relative rounded-[78px] shrink-0 size-[40px]" data-name="Icon">
      <div className="content-stretch flex items-start p-[2px] relative shrink-0" data-name="Mortgage">
        <div className="h-[20.004px] relative shrink-0 w-[20px]" data-name="vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20.0038">
            <path d={svgPaths.p51ee200} fill="var(--fill-0, black)" id="vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Content4() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Content">
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#006dff] text-[16px] text-center whitespace-nowrap">Simula tu Hipoteca aquí</p>
    </div>
  );
}
...
function Content3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-w-px relative self-stretch" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-black w-full" data-name="Title Text">
        <p className="font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">Simula tu hipoteca desde cero</p>
        <p className="font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] w-full">Descubre tu cuota mensual y encuentra la opción que mejor se adapte a ti</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-start max-w-[736px] relative shrink-0 w-full" data-name="Button Set">
        <div className="bg-white min-w-[96px] relative rounded-[100px] shrink-0" data-name="Button">
          <div className="content-stretch flex flex-col items-center justify-center min-w-[inherit] overflow-clip px-[16px] py-[4px] relative rounded-[inherit] size-full">
...
function Products1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="Products">
      <div className="bg-white min-w-[328px] relative rounded-[16px] shrink-0 w-full" data-name="Container UI">
        <div className="min-w-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col items-start min-w-[inherit] p-[16px] relative size-full">
            <div className="content-stretch drop-shadow-[0px_4px_10px_rgba(0,0,0,0.05)] flex flex-col gap-[16px] items-start max-w-[920px] min-w-[328px] relative rounded-[16px] shrink-0 w-[301px]" data-name="Product=Primary, Type=Tag, State=Default">
              <div className="content-stretch flex flex-col items-start justify-end relative shrink-0" data-name="_Tag_Product">
      ...
      <div className="bg-white min-w-[328px] relative rounded-[16px] shrink-0 w-full" data-name="Container UI">
        <div className="min-w-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col items-start min-w-[inherit] p-[16px] relative size-full">
            <div className="content-stretch drop-shadow-[0px_4px_10px_rgba(0,0,0,0.05)] flex gap-[16px] items-start justify-center max-w-[920px] min-w-[328px] relative rounded-[16px] shrink-0 w-full" data-name="Product=Primary, Type=Default, State=Default">
              <Icon />
              <Content3 />
            </div>
          </div>
...
function Primary() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-[358px]" data-name="Primary">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Title Text">
        <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[18px] text-black w-full">Contrátalo online</p>
      </div>
      <Products1 />
    </div>
  );
...
function Content5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-black w-full" data-name="Title Text">
        <p className="font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">Hipoteca Mixta</p>
        <p className="font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] w-full">Cuota fija al principio y variable al final</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-start max-w-[736px] relative shrink-0 w-full" data-name="Button Set">
        <div className="bg-white min-w-[96px] relative rounded-[100px] shrink-0" data-name="Button">
          <div className="content-stretch flex flex-col items-center justify-center min-w-[inherit] overflow-clip px-[16px] py-[4px] relative rounded-[inherit] size-full">
...
function Content7() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-black w-full" data-name="Title Text">
        <p className="font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">Hipoteca Fija</p>
        <p className="font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] w-full">Sin sorpresas, cada mes la misma cuota</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-start max-w-[736px] relative shrink-0 w-full" data-name="Button Set">
        <div className="bg-white min-w-[96px] relative rounded-[100px] shrink-0" data-name="Button">
          <div className="content-stretch flex flex-col items-center justify-center min-w-[inherit] overflow-clip px-[16px] py-[4px] relative rounded-[inherit] size-full">
...
function Content9() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start relative shrink-0 text-black w-full" data-name="Title Text">
        <p className="font-['Libre_Franklin:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] w-full">Hipoteca Variable</p>
        <p className="font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] w-full">Tu cuota mensual ajustada al mercado</p>
      </div>
      <div className="content-stretch flex gap-[8px] items-start max-w-[736px] relative shrink-0 w-full" data-name="Button Set">
        <div className="bg-white min-w-[96px] relative rounded-[100px] shrink-0" data-name="Button">
          <div className="content-stretch flex flex-col items-center justify-center min-w-[inherit] overflow-clip px-[16px] py-[4px] relative rounded-[inherit] size-full">
...
function Products2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Products">
      <div className="content-stretch flex flex-col items-start max-w-[448px] min-w-[328px] overflow-clip relative shrink-0 w-full" data-name="Secondary product">
        <Content5 />
      </div>
...
function Secondary() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-[358px]" data-name="Secondary">
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Title Text">
        <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[18px] text-black w-full">Nuestras hipotecas</p>
      </div>
      <Products2 />
    </div>
  );
...
function Products() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center px-[16px] py-[8px] relative shrink-0" data-name="Products">
      <Primary />
      <Secondary />
    </div>
  );
...
function Help() {
  return (
    <div className="relative shrink-0 w-full" data-name="Help">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-center px-[16px] py-[24px] relative size-full">
          <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Title Text">
            <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[18px] text-black w-full">¿No encuentras lo que buscas?</p>
          </div>
          <div className="bg-white max-w-[920px] min-w-[328px] relative rounded-[16px] shrink-0 w-full" data-name="Card">
...
function Bottom() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Bottom">
      <div className="h-[34px] relative shrink-0 w-[390px]" data-name="HomeIndicator">
...
function FamiliaProductosHipotecas() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-x-clip overflow-y-auto relative shrink-0 w-[390px]" data-name="Familia-productos_Hipotecas">
      <Top />
      <Products />
      <Help />
      <Bottom />
...
export default function FamiliaProductosHipotecasPreco() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative size-full" data-name="Familia-productos_Hipotecas-preco">
      <FamiliaProductosHipotecas />
    </div>
  );
}