import svgPaths from "./svg-i49cddij1e";
...
function Icon() {
  return (
    <div className="bg-[#eee] content-stretch flex items-center justify-center relative rounded-[100px] shrink-0 size-[72px]" data-name="Icon">
      ...
      <div className="content-stretch flex items-center justify-center p-[2px] relative rounded-[40px] shrink-0" data-name="Size=MD">
        <div className="relative shrink-0 size-[28px]" data-name="vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
            <path d={svgPaths.p166a7b30} fill="var(--fill-0, #424242)" id="vector" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full" data-name="Body">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-center justify-center px-[40px] relative size-full">
          <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] max-h-[48px] min-w-full overflow-hidden relative shrink-0 text-[#424242] text-[16px] text-center text-ellipsis w-[min-content]">Transferencia a Maria del Carmen</p>
          <div className="content-stretch flex items-baseline relative shrink-0" data-name="Amount">
            <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[32px] text-black text-right whitespace-nowrap">-500</p>
            <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[24px] text-black whitespace-nowrap">,00</p>
            <Currency />
          </div>
...
function Icon1() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[24px] shrink-0 size-[44px]" data-name="Icon">
      ...
      <div className="content-stretch flex items-start px-[3.25px] py-[2px] relative shrink-0" data-name="Size=SM">
        <div className="h-[20px] relative shrink-0 w-[17.503px]" data-name="vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5029 20">
            <path d={svgPaths.p2fb86b70} fill="var(--fill-0, #006DFF)" id="vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Content">
      <Icon1 />
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[18px] min-w-full overflow-hidden relative shrink-0 text-[12px] text-black text-center text-ellipsis w-[min-content]">Ver justificante</p>
    </div>
  );
}
          ...
          <div className="content-stretch flex flex-col items-start min-w-[inherit] p-[16px] relative size-full">
            <div className="content-stretch flex flex-col gap-[16px] isolate items-start relative shrink-0 w-full" data-name="State=Default">
              <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[326px] z-[11]" data-name="Info label">
                <Head />
                <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[28px] min-w-full relative shrink-0 text-[18px] text-black w-[min-content]">Transferencia a Maria del Carmen</p>
              </div>
  ...
  return (
    <div className="content-stretch flex items-start justify-end min-w-[104px] relative shrink-0" data-name="amount">
      <div className="content-stretch flex items-baseline justify-end min-w-[64px] relative shrink-0" data-name="Movement amount">
        <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] text-black text-right whitespace-nowrap">-20</p>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-end relative shrink-0 w-full" data-name="Concept + amount">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Libre_Franklin:Regular',sans-serif] font-normal justify-end leading-[0] min-w-px overflow-hidden relative text-[16px] text-black text-ellipsis">
        <p className="leading-[24px]">Transferencia a Maria del Carmen</p>
      </div>
      <Amount />
    </div>
  );
...
function Date() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-[48px] relative" data-name="Date">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[20px] min-w-px relative text-[#757575] text-[14px]">29 Dic</p>
    </div>
  );
}
...
export default function TransferDetail() {
  return (
    <div className="bg-white relative size-full" data-name="transfer detail">
      <Content />
      <Header1 />
    </div>
  );
