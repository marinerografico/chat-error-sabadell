import svgPaths from "./svg-szgr42s4ll";
import imgImageBrands from "./8d8af54c0f13ebd2e09efa6493290829085e6c76.png";
import { imgAvatar } from "./svg-n7k2l";
...
function Body1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center justify-center relative shrink-0 w-full" data-name="Body">
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] max-h-[48px] min-w-full overflow-hidden relative shrink-0 text-[#646464] text-[16px] text-center text-ellipsis w-[min-content]">Adeudo recibo Seguros Centro De Seguros Y Servicios Eci, S.A.</p>
      <div className="content-stretch flex items-baseline relative shrink-0" data-name="Amount">
        <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[24px] text-black whitespace-nowrap">-769</p>
        <p className="[word-break:break-word] font-['Libre_Franklin:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[18px] text-black whitespace-nowrap">,10</p>
        <Currency />
      </div>
      ...
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] text-black text-right whitespace-nowrap">Cuenta ••••1234</p>
    </div>
  );
}
          ...
          <div className="content-stretch flex items-center relative rounded-[50px] shrink-0" data-name="Avatar">
            <div className="overflow-clip relative rounded-[50px] shrink-0 size-[72px]" data-name="__Image&Brands">
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <img alt="" className="absolute left-[-14.46%] max-w-none size-[127.71%] top-[-13.25%]" src={imgImageBrands} />
              </div>
            </div>
...
function Content1() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[390px]" data-name="Content">
      <div className="content-stretch flex flex-col items-start max-w-[767px] min-w-[360px] relative shrink-0 w-full" data-name="Transaction Detail">
        <Header />
      </div>
    </div>
  );
...
function Icon() {
  return (
    <div className="content-stretch flex items-center justify-center p-[12px] relative rounded-[50px] shrink-0 size-[44px]" data-name="Icon">
      ...
      <div className="content-stretch flex items-center justify-center p-px relative shrink-0 size-[24px]" data-name="Size=SM">
        <div className="flex items-center justify-center relative shrink-0">
          <div className="-scale-y-100 flex-none rotate-180">
            <div className="h-[20.001px] relative w-[20px]" data-name="vector">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20.0006">
                <path d={svgPaths.p138f1e80} fill="var(--fill-0, #006DFF)" id="vector" />
              </svg>
            </div>
          </div>
        </div>
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Content">
      <Icon />
      <p className="[word-break:break-word] font-['Libre_Franklin:Regular',sans-serif] font-normal leading-[16px] min-w-full overflow-hidden relative shrink-0 text-[12px] text-black text-center text-ellipsis w-[min-content]">Devolver recibo</p>
    </div>
  );
}
                ...
                <div className="absolute contents inset-[-15%_-17.5%_-17.5%_-15%]" data-name="Symbol">
                  <div className="absolute contents inset-[-15%_-17.5%_-17.5%_-15%]" data-name="Merchant">
                    <div className="absolute inset-[-15%_-17.5%_-17.5%_-15%]" data-name="agbar">
                      <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgImageBrands} />
                      </div>
                    </div>
                  </div>
                </div>
...
export default function Adeudo() {
  return (
    <div className="relative size-full" data-name="adeudo">
      <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-0 max-w-[767px] min-w-[360px] overflow-clip top-0 w-[390px]" data-name="02_Account Position">
        <HeaderSlot />
        <Body />
      </div>
    </div>
