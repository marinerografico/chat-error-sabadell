import svgPaths from "../../imports/PreLogin/svg-o2iyc19jon";
import imgImage406 from "../../imports/PreLogin/d22b22b88e834e80c9ea53c0009c6983f4a2af65.png";

// PreLogin (PRE-LOGIN/02_Welcome). Renderizado fiel al diseño de Figma
// importado, con el CTA "Acceder" cableado para avanzar al login.
    ...
    <div className="bg-[#fafafa] flex-[1_0_0] min-h-px relative w-[390px]" data-name="Body">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start justify-center p-[32px] relative size-full">
          ...
          <button type="button" className="bg-white h-[48px] max-w-[500px] min-w-[240px] relative rounded-[50px] shrink-0 cursor-pointer" data-name="Button Primary">
...
function SwapContent({ onAcceder }: { onAcceder: () => void }) {
  return (
    <div className="relative shrink-0 w-full" data-name="Swap content">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center px-[16px] py-[24px] relative size-full">
          <button type="button" onClick={onAcceder} className="bg-[#006dff] min-w-[96px] relative rounded-[50px] shrink-0 w-full cursor-pointer" data-name="Category=Primary, Status=Default, Size=MD, No text=False">
...
function BottomActions({ onAcceder }: { onAcceder: () => void }) {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Bottom - Actions">
      <div className="bg-white content-stretch flex flex-col items-center max-w-[767px] min-h-[73px] min-w-[328px] overflow-clip relative shrink-0 w-full" data-name="Sticky panel">
        ...
        <SwapContent onAcceder={onAcceder} />
      </div>
    </div>
  );
}

export default function PreLogin({ onAcceder }: { onAcceder: () => void }) {
  return (
    <div className="bg-white flex flex-col h-full items-center justify-center overflow-hidden w-full" data-name="pre login">
      <NavigationSlot />
      <Body />
      <BottomActions onAcceder={onAcceder} />
    </div>
  );
}
